...
@section('title', 'Nueva Línea de Producción')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-8">
            <div class="mb-8">
                <h1 class="font-nav text-2xl font-bold text-gray-900">Registrar Nueva Línea de Producción</h1>
                <p class="text-sm text-gray-500 mt-1">Complete los datos para dar de alta a una nueva línea de producción en el sistema.</p>
            </div>

            <form action="{{ route('production_line.store') }}" method="POST" class="space-y-6">
                @csrf
