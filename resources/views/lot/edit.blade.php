    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-8">
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Complete los datos para dar actualizar el lote en el sistema.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <select id="product_id" name="product_id" 
                                ...
                                <option value="" disabled {{ old('product_id', $lot->product_id) ? '' : 'selected' }}>Seleccionar...</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="date" name="production_date" id="production_date" 
                             value="{{ old('production_date', $lot->production_date ? \Illuminate\Support\Carbon::parse($lot->production_date)->format('Y-m-d') : '') }}"  required
                            class="uppercase w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder:text-gray-400">
                    </div>
