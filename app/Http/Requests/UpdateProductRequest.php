...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name' => 'required|string|max:100|unique:product,name,' . $id . ',product_id',
            'code' => 'required|string|max:100|unique:product,code,' . $id . ',product_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'code.unique' => 'Ya existe otro producto con este código.',
